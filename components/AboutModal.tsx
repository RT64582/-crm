    ...
    <div className="fixed inset-0 bg-black bg-opacity-40 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="relative mx-auto p-6 border w-full max-w-2xl shadow-xl rounded-xl bg-white" onClick={e => e.stopPropagation()}>
        <div className="flex justify-between items-center border-b border-slate-200 pb-4">
          <h3 className="text-xl leading-6 font-bold text-slate-800">אודות LogiFlow AI</h3>
        ...
        <div className="mt-4 space-y-5 text-right p-2 max-h-[70vh] overflow-y-auto">
            <div>
                <h4 className="font-semibold text-slate-700 text-lg">מה זה LogiFlow AI?</h4>
            ...
            <div>
                <h4 className="font-semibold text-slate-700 text-lg">יכולות ליבה</h4>
                <ul className="list-disc list-inside mt-2 space-y-2 text-sm text-slate-600">
                    <li><span className="font-semibold">תמלול אודיו אמיתי:</span> המרת קבצי שמע של שיחות לטקסט מדויק.</li>
                    <li><span className="font-semibold">סיכום מנהלים:</span> הפקת תקציר תמציתי של עיקרי השיחה.</li>
                    <li><span className="font-semibold">ניתוח רגש:</span> הערכת שביעות רצון הלקוח עם ציון והסבר.</li>
                    <li><span className="font-semibold">זיהוי משימות:</span> חילוץ אוטומטי של משימות ומטלות מהשיחה עם קביעת דחיפות.</li>
                </ul>
            </div>
             <div>
                <h4 className="font-semibold text-slate-700 text-lg">טכנולוגיה</h4>
                <p className="text-slate-600 text-sm mt-1 leading-relaxed">
                    הפלטפורמה מונעת על ידי מודלי השפה המתקדמים של Google Gemini, המאפשרים הבנה וניתוח של שפה טבעית ברמה הגבוהה ביותר.
                </p>
            </div>
             <div>
                <h4 className="font-semibold text-slate-700 text-lg">פיתוח</h4>
                <p className="text-slate-600 text-sm mt-1 leading-relaxed">
